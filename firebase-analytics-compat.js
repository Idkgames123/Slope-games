! function(e, t) {
    ...
    try {
        !(function() {
            ...
            }, "PRIVATE")), mt.registerVersion(lt, "0.10.1"), mt.registerVersion(lt, "0.10.1", "esm2017");
            var ut, dt, pt;
            class ft {
                constructor(e, t) {
            ...
            pt = {
                ...
                isSupported: at,
                EventName: ut
            }, n.default.INTERNAL.registerComponent(new b("analytics-compat", gt, "PUBLIC").setServiceProps(pt).setMultipleInstances(!0)), n.default.registerVersion("@firebase/analytics-compat", "0.2.7")
